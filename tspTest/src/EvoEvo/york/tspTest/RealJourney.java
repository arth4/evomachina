...
public class RealJourney extends Individual {
    private final static Logger _logger = Logger.getLogger("EvoEvo");

    public RealJourney(Optional<Space> container) {
        super(container);
    }
    ...
    /* package private */ Double journeyTime() {
        RTSPCalculator calculatorMachine = (RTSPCalculator)this.locateMachine(RTSPCalculator.class);
    ...
    public int compareTo(Individual o) {
        if (!RealJourney.class.isAssignableFrom(o.getClass())) throw new MetaModelException(String.format("Cannot compare individual of type %s with one of type %s", o.getClass(), RealJourney.class));

        RealJourney j = (RealJourney)o;
